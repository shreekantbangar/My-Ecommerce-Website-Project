          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Hno: 222 Near Bank of Baroda Tower, <br /> Shahapur,
                  Maharashtra <br />
                  PinCode: 421603
                </address>
                <a
                  href="tel:+91 9222036222"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +91 9222036222
                </a>
                <a href="mailto:" className="mt-2 d-block mb-4 text-white">
                  shreekantbangar22@gmail.com
                </a>
            ...
            <div className="col-3">
              ...
              <div className="footer-link d-flex flex-column">
                ...
                <Link to="/termof-service" className="text-white py-2 mb-1">Term of Service</Link>
