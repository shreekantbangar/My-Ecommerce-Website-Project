            ...
            <div className="col-7">
              <div className="checkout-left-data">
                ...
                <p className="user-details total">
                  Shreekant Bangar (shreekantbangar22@gmail.com)
                </p>
              ...
              <div className="border-bottom py-4">
                <div className="d-flex mb-2 gap-10 align-items-center">
                  ...
                  <span style={{"top":"-10px", "right":"2px"}} className="badge bg-secondary text-white rounded-circle p-2 position-absolute">1</span>
                    <img className="img-fluid" src={watch1} alt="product" />
                  </div>
                   <div>
                     <h5 className="total-price">Best Crono Watch</h5>
                     <p className="total-price"> s / fdsfss</p>
                   </div>
                  </div>
                  <div className="flex-grow-1">
